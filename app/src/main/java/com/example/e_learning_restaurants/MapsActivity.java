...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(@NonNull GoogleMap googleMap) {
        ...
        mMap.setOnMarkerClickListener(marker -> {
            ...
            Toast.makeText(MapsActivity.this, "Wybrana restauracja" + markerName, Toast.LENGTH_SHORT).show();
            return false;
        });
    }
    ...
    private void showAlertDialog(LatLng latLng) {
        ...
        builder.setTitle("Wprowadz nazwe restauracji");
        ...
        builder.setPositiveButton("Add", (dialog, which) -> {
            ...
            Toast.makeText(this, "Dodano: " + inputText, Toast.LENGTH_SHORT).show();
        });

        builder.setNegativeButton("Wroc", (dialog, which) -> dialog.cancel());
